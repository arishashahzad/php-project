        ...
        <div class="table-responsive mt-2">
          <table class="table table-bordered table-striped text-center">
            <thead>
              <tr>
                <td colspan="7">
                  <h4 class="text-center text-info text-dark mb-2 mt-2 m-0" style="font-size: 30px">Products in your cart!</h4>
                </td>
              </tr>
              <tr>
                <th>ID</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="../admin/pages/uploads/<?= $row['product_image'] ?>" width="50"></td>
              ...
              <tr>
                <td colspan="3">
                  <a href="index.php" class="btn btn-success text-white"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continue
                    Shopping</a>
                </td>
