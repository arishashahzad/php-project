...
if(isset($_POST["submit"])){
  ...
  $insert = "INSERT INTO `banners`(`name`, `price`, `detail`, `image`,`option`) VALUES (' $name',$price,'$detail','$filename','$option')";
            ...
            <div class="card card-primary">
              ...
              <form id="quickForm" enctype="multipart/form-data" method="POST" >
                <div class="card-body">
                  ...
                  <select style="width: 20%;font-size: 20px; " class=" mb-2" name="option" required>
